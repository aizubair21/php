...
class student
{
     ...
     */
    public function __set($Property, $value) //take a peremitter, a private or protected poperty which you call
    {
        // return $Property . " is private. You can't see this"; //if you call a private/protected property this error is shown

        echo "old value : " . $this->studentInfo["$Property"];
        echo "<br>";
        $this->studentInfo["$Property"] = $value;
        echo "new value : " . $this->studentInfo["$Property"];
    }
}
